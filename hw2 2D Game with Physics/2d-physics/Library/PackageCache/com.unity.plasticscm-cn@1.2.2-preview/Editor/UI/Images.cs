...
namespace Unity.PlasticSCM.Editor.UI
{
    internal class Images
    {
        ...
        internal static Texture2D GetImage(Name image)
        {
            ...
            string imageFilePath2x = GetImageFilePath(imageFileName);

            string darkImageFilePath = GetImageFilePath(darkImageFileName);
            string darkImageFilePath2x = GetImageFilePath(darkImageFileName2x);
        ...
        static string GetImageFilePath(string imageFileName)
        {
            return Path.Combine(GetImagesFolder(), imageFileName);
        }
        ...
        static Texture2D TryLoadImage(string imageFilePath, string image2xFilePath)
        {
            ...
            if (File.Exists(imageFilePath))
                return LoadTextureFromFile(imageFilePath);
