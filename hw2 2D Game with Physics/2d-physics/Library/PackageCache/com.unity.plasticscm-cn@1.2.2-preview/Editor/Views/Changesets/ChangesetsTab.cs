...
namespace Unity.PlasticSCM.Editor.Views.Changesets
{
        ...
        ChangesetsViewMenu.IMenuOperations
    {
        ...
        {
            List<RepObjectInfo> selectedChangesets = ChangesetsSelection.GetSelectedRepObjectInfos(
                mChangesetsListView);
            ...
            bool wasChecked)
        {
            string buttonText = wasChecked ?
                HIDE_CHANGEST_TXT : SHOW_CHANGEST_TXT;
            ...
            EditorWindow parentWindow)
        {
            ...
            ChangesetsListHeaderState headerState = ChangesetsListHeaderState.Default;
        ...
        const string HIDE_CHANGEST_TXT = "Hide changes";
        const string SHOW_CHANGEST_TXT = "Show changes";
    }
}
